...
"**信镜 (TrustLens)**" 是一个从0实现的创新型多智能体数据分析系统，致力于穿透信息迷雾，精准、客观地反映舆情真相。用户只需像聊天一样提出分析需求，系统即可全自动分析国内外30+主流社媒与数百万条大众评论，最终生成高质量的深度研究报告。

> "信镜"寓意"可信赖的观察之镜"（Trustworthy Lens），象征着项目致力于成为简洁通用的数据分析引擎，帮助用户破除信息茧房，还原舆情原貌，预测未来走向，辅助决策。
